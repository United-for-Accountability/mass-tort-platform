...
export default function DeclarationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, 'DeclarationOfEstateInheritanceTax'), submissionData);
      setSubmitted(true);
  ...
  return (
    <>
      <Head>
        <title>Declaration to End the Estate Inheritance Tax | United for Accountability</title>
        <meta name="description" content="Sign the declaration to abolish the estate inheritance tax and defend constitutional rights and generational wealth." />
      </Head>
      ...
      <main className="bg-gray-50 py-12 px-6 md:px-12 lg:px-24">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold text-blue-700 mb-6">✍️ Declaration to End the Estate Inheritance Tax</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
            ...
            <div>
              <label htmlFor="race" className="block text-sm font-medium text-gray-700">Race (optional)</label>
            ...
            <div>
              <label htmlFor="statement" className="block text-sm font-medium text-gray-700">Statement (optional)</label>
              <textarea id="statement" name="statement" rows="4" onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"></textarea>
            </div>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="consent_checked" className="ml-2 block text-sm text-gray-700">
                I consent to the use of my declaration for this case.
              </label>
            </div>
