  ...
  <div className="space-y-6">
    ...
    <div>
      ...
      <p className="text-sm text-blue-700 font-semibold mt-2">
        👉 <a href="/utilities-harm">Submit Your Utility or Infrastructure Harm Story</a>
      </p>
    </div>
    ...
    <div>
      ...
      <p className="text-sm text-blue-700 font-semibold mt-2">
        👉 <a href="/insurance-harm">Submit Your Insurance Harm Story</a>
      </p>
    </div>
    ...
    <div>
      ...
      <p className="text-sm text-blue-700 font-semibold mt-2">
        👉 <a href="/civil-rights">Submit Your Civil Rights Violation</a>
      </p>
    </div>
    ...
    <div>
      ...
      <p className="text-sm text-blue-700 font-semibold mt-2">
        👉 <a href="/media-censorship">Submit Your Experience with Digital Suppression</a>
      </p>
    </div>
  </div>
