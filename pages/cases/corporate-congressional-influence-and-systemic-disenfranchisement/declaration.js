...
export default function DeclarationForm() {
  ...
  return (
    <>
      <Head>
        <title>Declaration Against Corporate Congressional Influence | United for Accountability</title>
        <meta name="description" content="Sign the public declaration to end corporate congressional influence and systemic disenfranchisement under the 9th Amendment." />
      </Head>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-16 border-t pt-10">
            ...
            <p className="text-gray-800 text-lg mb-6">
              ...
              <strong className="text-blue-900">The chance to live a fulfilling life, free from systemic control.</strong><br />
